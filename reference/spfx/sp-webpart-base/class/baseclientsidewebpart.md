...
|`propertiesMetadata`     | `public` | [`IWebPartPropertiesMetadata `](../../sp-webpart-base/interface/iwebpartpropertiesmetadata.md),` undefined` | _Read-only._ This property defines metadata for the web part property bag. The metadata can help SharePoint understand the content of the properties better and perform relevant services on the data. |
