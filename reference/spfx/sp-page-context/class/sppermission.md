...
|`manageLists`     | `public` | [`SPPermission`](../sp-page-context/class/sppermission.md) | Create and delete lists, add or remove columns in a list, and add or remove public views of a list. |
