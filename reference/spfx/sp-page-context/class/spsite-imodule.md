...
|`correlationId`     | `public` | [`Guid`](../../sp-core-library.api/class/guid.md) | _Read-only._ Returns the correlation id to the current server request. |
|`id`     | `public` | [`Guid`](../../sp-core-library.api/class/guid.md) | _Read-only._ The GUID that identifies the SPSite on the server. |
