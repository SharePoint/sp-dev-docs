...
|:-------------|:-------|:-----------|
|`Children`      | [`IODataNavigationNode`](../../sp-odata-types.api/interface/iodatanavigationnode.md)[] | Gets or sets an array of Navigation Nodes that are children to the current node. |
