...
<tr class="even">
<td align="left"># IsNull Element (Query)</td>
</tr>
<tr class="odd">
...
Used within a query to return items that are empty (<span
...
The following query returns cases where the field base type is 1, the ID
column equals the Project column, and the Template column is empty.
