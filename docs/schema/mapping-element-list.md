...
<tr class="even">
<td align="left"># MAPPING Element (List)</td>
</tr>
<tr class="odd">
...
Maps a value to a choice that is displayed in a <span
...
<td align="left"><p>Required **Text**. Specifies the value that is mapped to a choice.</p></td>
</tr>
</tbody>
</table>
