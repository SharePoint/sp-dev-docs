...
<tr class="even">
<td align="left"># Type Element (Event)</td>
</tr>
<tr class="odd">
...
The **Type** element contains an integer
corresponding to one of the <span sdata="cer"
target="T:Microsoft.SharePoint.SPEventReceiverType"><span
class="nolink">Microsoft.SharePoint.SPEventReceiverType</span></span>
values.
