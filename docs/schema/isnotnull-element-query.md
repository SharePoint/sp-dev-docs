...
<tr class="even">
<td align="left"># IsNotNull Element (Query)</td>
</tr>
<tr class="odd">
...
Used within a query to return items that are not empty (<span
...
<span sdata="link">[IsNull Element
(Query)](isnull-element-query.htm)</span>
