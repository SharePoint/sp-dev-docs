...
<tr class="even">
<td align="left"># IfHasRights Element (View)</td>
</tr>
<tr class="odd">
...
Allows for conditional rendering of a field or of a toolbar item based
on whether the current user has the specified permission.
