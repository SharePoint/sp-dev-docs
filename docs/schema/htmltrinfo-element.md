...
<tr class="even">
<td align="left"># HtmlTrInfo Element</td>
</tr>
<tr class="odd">
...
Used in HtmlTransInfo.xml file (<span class="code">\\Program
Files\\Common Files\\Microsoft Shared\\web server
extensions\\12TEMPLATE\\XML</span>) to contain mapping instructions for
directing a request to the URL for handling a request when the client
computer does not have the 2007 Microsoft Office system installed.
...
When the client computer does not have the Office application installed,
Microsoft SharePoint Foundation creates an HTML rendition of the page by
using a converter program on the server.
