...
<tr class="even">
<td align="left"># MAPPINGS Element (List)</td>
</tr>
<tr class="odd">
...
Contains mappings of values to the choices displayed within a <span
...
The following excerpt shows how to implement the <span
