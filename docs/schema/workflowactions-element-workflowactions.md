...
<tr class="even">
<td align="left"># WorkflowActions Element (WorkflowActions)</td>
</tr>
<tr class="odd">
...
**WorkflowActions** is the root element of the
WorkflowActions schema. This element must be included in any Feature
manifest file for sandboxed deployed custom actions.
