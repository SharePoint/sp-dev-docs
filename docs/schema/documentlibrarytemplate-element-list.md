...
<tr class="even">
<td align="left"># DocumentLibraryTemplate Element (List)</td>
</tr>
<tr class="odd">
...
Used in the wire protocol that the server uses to export list metadata
to the SharePoint Designer client. This element specifies which file
serves as the template document for a document library.
...
The following example indicates that the document library whose schema
