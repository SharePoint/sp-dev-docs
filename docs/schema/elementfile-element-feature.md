...
<tr class="even">
<td align="left"># ElementFile Element (Feature)</td>
</tr>
<tr class="odd">
...
In the following example, the **ElementFile**
element is used to deploy language resources used to localize a Feature.
