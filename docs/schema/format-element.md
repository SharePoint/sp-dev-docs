...
<tr class="even">
<td align="left"># Format Element</td>
</tr>
<tr class="odd">
...
Contains definitions of column and row formatting that are used in a
Datasheet view.
...
<td align="left"><p>Required **Text**. Contains the name of the field to which the format applies.</p></td>
</tr>
</tbody>
</table>
