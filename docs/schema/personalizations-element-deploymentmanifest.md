...
<tr class="even">
<td align="left"># Personalizations Element (DeploymentManifest)</td>
</tr>
<tr class="odd">
...
Represents a collection of personalization elements pertaining to an
instance of a Windows SharePoint Services 3.0 file (<span sdata="cer"
