...
<tr class="even">
<td align="left"># MapToAll Element (View)</td>
</tr>
<tr class="odd">
...
The **MapToAll** element improves performance
by preventing the need to make multiple requests to the server for data.
