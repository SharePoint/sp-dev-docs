...
<tr class="even">
<td align="left"># DataSource Element (WorkflowActions)</td>
</tr>
<tr class="odd">
...
<td align="left"><p>Required **text</span>. Specifies how to differentiate the user interface (UI) elements that are defined in a <span class="keyword">DataSource</span> element. If the value begins with &quot;Parent.&quot;, the value is retrieved from the parent of the action or composite step that declares the <span class="keyword">DataSource** element.</p></td>
</tr>
</tbody>
</table>
