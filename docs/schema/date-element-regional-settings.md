...
<tr class="even">
<td align="left"># Date Element (Regional Settings)</td>
</tr>
<tr class="odd">
...
Shared\\web server extensions\\15\\CONFIG) to contain the date and time
on which standard time or daylight saving time begins for a time zone.
