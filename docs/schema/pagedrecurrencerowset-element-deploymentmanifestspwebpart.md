...
<tr class="even">
<td align="left"># PagedRecurrenceRowset Element (DeploymentManifest - SPWebPart)</td>
</tr>
<tr class="odd">
...
Represents a row set returned from a paged recurrence on an instance of
a SharePoint Web Part (<span sdata="cer"
