...
<tr class="even">
<td align="left"># AssociationData Element (Workflow)</td>
</tr>
<tr class="odd">
...
Specifies any custom, valid XML data to pass to the workflow association
form. The association form you specify for this workflow must be able to
parse the data.
