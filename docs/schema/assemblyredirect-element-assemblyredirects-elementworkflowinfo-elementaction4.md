...
<tr class="even">
<td align="left"># AssemblyRedirect element (AssemblyRedirects element) (WorkflowInfo element) (Action4)</td>
</tr>
<tr class="odd">
...
Specifies a transformation from one binary file to another binary file
in a versioned binary file system so that the client has sufficient
information to load the desired binary file.
