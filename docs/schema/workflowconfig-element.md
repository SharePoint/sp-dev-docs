...
<tr class="even">
<td align="left"># WorkflowConfig Element</td>
</tr>
<tr class="odd">
...
Contains the information necessary for declarative, rules-based,
code-free workflow editors to generate a workflow template and associate
that workflow template with the specified SharePoint Foundation 2010
list.
