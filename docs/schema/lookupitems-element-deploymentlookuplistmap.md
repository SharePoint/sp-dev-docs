...
<tr class="even">
<td align="left"># LookupItems Element (DeploymentLookupListMap)</td>
</tr>
<tr class="odd">
...
Represents a collection of lookup item (<span
class="keyword">SPLookupItem</span>) instances. Provides a list of
lookup references from list item to list item.
