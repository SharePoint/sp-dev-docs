...
<tr class="even">
<td align="left"># WebTemplateIdDefinition simpleType (SharePoint Add-in Manifest)</td>
</tr>
<tr class="odd">
...
This type is a string of the form <span class="code">{</span><span
class="placeholder">hyphenated\_GUID</span><span
