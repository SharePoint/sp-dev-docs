...
<tr class="even">
<td align="left"># RoleAssignments Element (DeploymentManifest)</td>
</tr>
<tr class="odd">
...
Represents a collection of deployment role assignment (<span
class="keyword">DeploymentRoleAssignments</span>) objects.
...
**DeploymentRoleAssignments** (based on <span
sdata="cer"
target="T:Microsoft.SharePoint.SPRoleAssignmentCollection"><span
class="nolink">SPRoleAssignmentCollection</span></span>)
