...
description: Discusses the ActivityBody element which is a complex type coercionParametersType, for complex binding of an activity that is used as a coercion.
manager: soliver
ms.date: 3/9/2015
