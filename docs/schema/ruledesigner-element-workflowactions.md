...
<tr class="even">
<td align="left"># RuleDesigner Element (WorkflowActions)</td>
</tr>
<tr class="odd">
...
Complex type element. The **RuleDesigner**
element contains information that is needed to render a workflow
sentence in a declarative, code-free workflow editor, such as Microsoft
