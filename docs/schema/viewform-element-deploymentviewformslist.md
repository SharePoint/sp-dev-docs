...
<tr class="even">
<td align="left"># ViewForm Element (DeploymentViewFormsList)</td>
</tr>
<tr class="odd">
...
Represents the specific Web Part object (<span
class="keyword">SPViewForm</span>) instances that are listed in the
ViewFormsList.xml file, which is exported to the content migration
package. The ViewFormsList.xml file specifies whether each instance is a
view or a form.
...
<td align="left"><p>Optional. Unique identifier that identifies each specific Web Part.</p></td>
</tr>
<tr class="even">
