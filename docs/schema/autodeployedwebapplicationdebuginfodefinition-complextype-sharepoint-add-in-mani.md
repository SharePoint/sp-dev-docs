...
<tr class="even">
<td align="left"># AutoDeployedWebApplicationDebugInfoDefinition complexType (SharePoint Add-in Manifest)</td>
</tr>
<tr class="odd">
...
The add-in principal information used for debugging purpose.
