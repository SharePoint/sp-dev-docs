...
<tr class="even">
<td align="left"># Dictionary element (SchemaSource element) (dataSourceType complexType) (Action4)</td>
</tr>
<tr class="odd">
...
Specifies a dictionary of name-value pairs from which to retrieve
fields.
...
<td align="left"><p>The specified dictionary.</p></td>
