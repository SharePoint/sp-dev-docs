...
<tr class="even">
<td align="left"># ViewFooter Element (DeploymentManifest - SPView)</td>
</tr>
<tr class="odd">
...
Represents a parameter that defines the view of the footer area on an
instance of a Windows SharePoint Services 3.0 view (<span sdata="cer"
...
<span sdata="cer"
target="P:Microsoft.SharePoint.SPView.ViewFooter"><span
class="nolink">ViewFooter</span></span>
