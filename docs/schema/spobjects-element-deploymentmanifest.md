...
<tr class="even">
<td align="left"># SPObjects Element (DeploymentManifest)</td>
</tr>
<tr class="odd">
...
Represents a collection of top-level Windows SharePoint Services 3.0
objects.
...
The **SPObjects** element is the root element
of the DeploymentManifest.xsd schema and therefore has no parent
element.
