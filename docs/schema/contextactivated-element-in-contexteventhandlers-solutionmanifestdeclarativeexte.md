...
<tr class="even">
<td align="left"># ContextActivated Element in ContextEventHandlers (SolutionManifestDeclarativeExtensions Schema)</td>
</tr>
<tr class="odd">
...
The <span
class="keyword">DOCS-LESSTHANContextActivatedDOCS-GREATERTHAN</span>
