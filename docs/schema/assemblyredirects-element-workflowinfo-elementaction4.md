...
<tr class="even">
<td align="left"># AssemblyRedirects element (WorkflowInfo element) (Action4)</td>
</tr>
<tr class="odd">
...
Specifies transformations from one binary file to another binary file in
a versioned binary file system so that the client has sufficient
