...
<tr class="even">
<td align="left"># ContentTypeRef Element (List)</td>
</tr>
<tr class="odd">
...
Specifies a reference to a content type to associate with lists that are
...
<td align="left"><p>Required **Text**. Specifies the ID of the content type. For information on the format of content type IDs, see <a href="http://msdn.microsoft.com/library/81fa8d81-c4f5-4750-8f70-811620fdffcf(Office.15).aspx">Content Type IDs</a>.</p></td>
</tr>
</tbody>
</table>
