...
<tr class="even">
<td align="left"># ListFormButtons Element (List)</td>
</tr>
<tr class="odd">
...
The **ListFormButtons** element is used in the
[Schema.xml](http://msdn.microsoft.com/library/c2f01064-80d8-47ee-b602-ecf4c480ac56(Office.15).aspx)
file with the other list form elements to create the Display, Edit, and
New forms for a list.
