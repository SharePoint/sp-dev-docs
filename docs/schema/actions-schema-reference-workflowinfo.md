...
description: The Actions schema that is used to validate custom .ACTIONS files does not actually exist in the form of an .xsd file on the server file system. 
manager: laurawi
ms.date: 11/16/2014
