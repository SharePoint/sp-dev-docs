...
<tr class="even">
<td align="left"># SiteFeatures Element (Site)</td>
</tr>
<tr class="odd">
...
Specifies site collection Features to activate in site collections that
are created through the site definition.
...
Microsoft SharePoint Foundation activates features specified within the
