...
<tr class="even">
<td align="left"># Properties Element (DeploymentManifest - SPAttachment)</td>
</tr>
<tr class="odd">
...
Represents a collection of properties on a Windows SharePoint Services
3.0 attachment. Use the Attachments property of the <span sdata="cer"
target="T:Microsoft.SharePoint.SPListItem"><span
class="nolink">SPListItem</span></span> class to retrieve a collection
of attachements for a list item.
