...
<tr class="even">
<td align="left"># ExcludeOtherColumns (SPMetal)</td>
</tr>
<tr class="odd">
...
The following shows the ExcludeOtherColumns element in use. The presence
of the element ensures that code generated for the Contact content type
