...
<tr class="even">
<td align="left"># Template Element (Site)</td>
</tr>
<tr class="odd">
...
<td align="left"><p>Required **Integer**. Specifies the ID of the site definition. To avoid conflict with IDs that are natively used in Microsoft SharePoint Foundation, use IDs with values greater than 10,000 when you create custom site definitions.</p></td>
</tr>
<tr class="even">
<td align="left"><p>**Name**</p></td>
<td align="left"><p>Required **Text**. Contains the name of the site type, such as STS.</p></td>
</tr>
<tr class="odd">
