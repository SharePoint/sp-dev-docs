...
<tr class="even">
<td align="left"># ViewBidiHeader Element (DeploymentManifest - SPWebPart)</td>
</tr>
<tr class="odd">
...
Represents a parameter that permits a view of a header on a Windows
SharePoint Services 3.0 view object that supports bidirectional printer
(bidi) communication.
