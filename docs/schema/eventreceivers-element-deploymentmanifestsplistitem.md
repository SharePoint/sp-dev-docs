...
<tr class="even">
<td align="left"># EventReceivers Element (DeploymentManifest - SPListItem)</td>
</tr>
<tr class="odd">
...
implementing event handling on SharePoint list item (<span sdata="cer"
target="T:Microsoft.SharePoint.SPListItem"><span
class="nolink">SPListItem</span></span>) objects.
