...
<tr class="even">
<td align="left"># View Body Element (DeploymentManifest - SPView)</td>
</tr>
<tr class="odd">
...
Represents a parameter that enables a view of the body of an instance of
a Windows SharePoint Services 3.0 view (<span sdata="cer"
target="T:Microsoft.SharePoint.SPView"><span
...
<span sdata="cer" target="P:Microsoft.SharePoint.SPView.ViewBody"><span
class="nolink">ViewBody</span></span>
