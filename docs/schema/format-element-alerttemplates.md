...
<tr class="even">
<td align="left"># Format Element (AlertTemplates)</td>
</tr>
<tr class="odd">
...
Modifies the appearance of an alert message. You can also customize the
formatting of the alert message by using embedded styles.
