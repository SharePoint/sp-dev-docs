...
<tr class="even">
<td align="left"># RootFile Element (Solution)</td>
</tr>
<tr class="odd">
...
<td align="left"><p>Required **Text**. A path that is relative to %ProgramFiles%\Common Files\Microsoft Shared\web server extensions\15\.</p></td>
</tr>
</tbody>
</table>
...
Use this element to deploy a localization resource that is shared by
several features. Shared localization resources are located in the
