...
<tr class="even">
<td align="left"># MapToText Element</td>
</tr>
<tr class="odd">
...
Returns the name of the application in which a document was created,
based on the file name extension and <span
class="keyword">ProgID</span>.
