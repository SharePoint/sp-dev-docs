...
<tr class="even">
<td align="left"># LookupLists Element (DeploymentLookupListMap)</td>
</tr>
<tr class="odd">
...
Represents a collection of deployment lookup list (<span
class="keyword">SPLookupList</span>) objects exported to the content
migration package.
...
The **LookupLists **element is the root element
in the **DeploymentLookupListMap** Schema, and
therefore has no parent element.
