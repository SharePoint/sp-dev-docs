...
description: The Server Ribbon schema defines the structure of XML documents that customize the Server ribbon.
---
...
- [Controls (Group)](controls-element-group.md)
- [Controls (MenuSection)](controls-element-menusection.md)
