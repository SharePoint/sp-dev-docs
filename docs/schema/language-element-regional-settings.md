...
<tr class="even">
<td align="left"># Language Element (Regional Settings)</td>
</tr>
<tr class="odd">
...
Shared\\web server extensions\\15\\TEMPLATE\\1033\\XML) to specify a
natural language in the regional settings, or used within a field
display pattern to render a language name.
...
<td align="left"><p>Optional **Integer**. Specifies the locale identifier (LCID) for the language. Used in RGNLSTNG.XML.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>**Name**</p></td>
<td align="left"><p>Optional **Text**. Specifies the name of the language. Used in RGNLSTNG.XML.</p></td>
</tr>
</tbody>
</table>
