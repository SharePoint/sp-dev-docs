...
<tr class="even">
<td align="left"># MapToControl Element (View)</td>
</tr>
<tr class="odd">
...
Returns the name of the application in which a document can be edited
based on the file name extension and ProgID.
...
The **MapToControl** element uses the following
