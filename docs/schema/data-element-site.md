...
<tr class="even">
<td align="left"># Data Element (Site)</td>
</tr>
<tr class="odd">
...
A top-level CAML element that is used to specify sets of data. In
[Onet.xml](http://msdn.microsoft.com/library/b99d6657-d9ae-4135-a43c-c58cdfcdc6c1(Office.15).aspx)
files, it specifies a default set of data for a newly created list.
