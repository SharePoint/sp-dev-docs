...
<td align="left"><p>xs:string</p></td>
<td align="left"><p>Optional. Path to the front-end file location in cases where the **IsGhosted</span> attribute is <span class="keyword">true**.</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>Optional. Specifies Microsoft SharePoint Foundation version. The value **2</span> specifies Windows SharePoint Services 2.0; the value <span class="keyword">3** specifies Windows SharePoint Services 3.0.</p></td>
</tr>
</tbody>
</table>
