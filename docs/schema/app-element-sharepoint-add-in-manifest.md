...
<tr class="even">
<td align="left"># App element (SharePoint Add-in Manifest)</td>
</tr>
<tr class="odd">
...
The top level node of the manifest of an SharePoint Add-in.
...
<td align="left"><p>A list of resources that an SharePoint Add-in needs to access.</p></td>
</tr>
<tr class="even">
