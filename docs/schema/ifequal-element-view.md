...
<tr class="even">
<td align="left"># IfEqual Element (View)</td>
</tr>
<tr class="odd">
...
Allows for conditional rendering based on the comparison of two
Collaborative Application Markup Language (CAML) expressions.
...
element to define the display pattern for the <span
class="keyword">Checked Out To</span> column. If the user ID equals
