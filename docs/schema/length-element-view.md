...
<tr class="even">
<td align="left"># Length Element (View)</td>
</tr>
<tr class="odd">
...
Returns the length of the string within the element. The value returned
can be divided by, or subtracted from, the value of the <span
class="keyword">Div</span> or **Sub**
...
<td align="left"><p>Optional **Integer**. Specifies how much to divide the resulting value by.</p></td>
</tr>
<tr class="even">
<td align="left"><p>**Sub**</p></td>
<td align="left"><p>Optional **Integer**. Specifies how much to subtract from the resulting value.</p></td>
</tr>
</tbody>
</table>
