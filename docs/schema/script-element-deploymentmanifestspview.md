...
<tr class="even">
<td align="left"># Script Element (DeploymentManifest - SPView)</td>
</tr>
<tr class="odd">
...
Represents script to execute on deployment of an instance of a Windows
SharePoint Services 3.0 view (<span sdata="cer"
