...
<tr class="even">
<td align="left"># Folder Element (ContentType)</td>
</tr>
<tr class="odd">
...
Specifies the relative folder path for the content type's resource
folder.
...
The resource folder is the storage location for any file, such as a
document template, that is used by the content type.
...
<span sdata="cer"
target="P:Microsoft.SharePoint.SPContentType.ResourceFolder"><span
class="nolink">ResourceFolder</span></span>
