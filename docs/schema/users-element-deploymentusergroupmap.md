...
<tr class="even">
<td align="left"># Users Element (DeploymentUserGroupMap)</td>
</tr>
<tr class="odd">
...
Represents a collection of deployment user (<span
class="keyword">DeploymentUser</span>) object instances.
