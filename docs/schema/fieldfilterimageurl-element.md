...
<tr class="even">
<td align="left"># FieldFilterImageURL Element</td>
</tr>
<tr class="odd">
...
Returns the URL to the icon that is used to indicate filtering on a
list.
...
file in the HeaderPattern sections.


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

The following excerpt uses the <span
class="keyword">FieldFilterImageURL</span> element to assemble the
\<IMG\> tag for displaying the filter image.
