...
<tr class="even">
<td align="left"># Day Element (Regional Settings)</td>
</tr>
<tr class="odd">
...
representing the day of the month on which standard time or daylight
saving time begins for a time zone.
...
example that shows how to use the **Day**
element.
