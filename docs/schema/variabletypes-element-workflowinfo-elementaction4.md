...
<tr class="even">
<td align="left"># VariableTypes element (WorkflowInfo element) (Action4)</td>
</tr>
<tr class="odd">
...
Container for **VariableType** elements, which
specify the available types for local variables in the workflow.
