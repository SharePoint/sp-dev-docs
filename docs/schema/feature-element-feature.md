...
description: Provides definition, elements and attributes, and link to an example of how feature element is used in SharePoint.
manager: soliver
ms.date: 3/9/2015
...
<p>The resource file is named according to the format `\<Feature\>\Resources\Resources.<Culture Name>.resx`, where `<Culture Name>` is the name that identifies the culture. SharePoint Foundation supports the following formats for culture names:</p>
<p>`ll-CC`</p>
<p>`ll-Ssss-CC`</p><br/>
