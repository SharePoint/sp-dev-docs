...
<tr class="even">
<td align="left"># IncludeHiddenLists (SPMetal)</td>
</tr>
<tr class="odd">
...
A Web element cannot have both an ExcludeOtherLists element and an
IncludeHiddenLists element.


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

The following is an example of an ExcludeOtherLists element in use. In
