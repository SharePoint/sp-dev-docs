...
<tr class="even">
<td align="left"># SupportedLocale element (SupportedLocalesDefinition complexType) (SharePoint Add-in Manifest)</td>
</tr>
<tr class="odd">
...
Specifies a locale that the add-in supports.
...
<tbody>
<tr class="odd">
<td align="left"><p>Although the **maxOccurs</span> attribute in the XSD for the add-in manifest markup is set to 256, the Office Store may set a lower effective maximum. As of the release of SharePoint 2013, there is an effective maximum of 25 <span class="keyword">SupportedLocale</span> elements in the parent <span class="keyword">SupportedLocales** element.</p></td>
</tr>
</tbody>
</table>
