...
<tr class="even">
<td align="left"># ImagesPath Element</td>
</tr>
<tr class="odd">
...
Returns the HTTP path to the images directory for the project, including
...
The following example uses the **ImagesPath**
element to specify the path for the **Edit**
icon.
