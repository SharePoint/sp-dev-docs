...
<tr class="even">
<td align="left"># SystemData Element (DeploymentSystemData)</td>
</tr>
<tr class="odd">
...
Represents a system data wrapper object (<span
class="keyword">SPSystemData</span>) that contains the deployment system
data object collections. This is the schema root element.
...
The **SystemData** element is the schema root
element and therefore has no parent element.
