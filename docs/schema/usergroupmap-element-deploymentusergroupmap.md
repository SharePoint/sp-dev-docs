...
<tr class="even">
<td align="left"># UserGroupMap Element (DeploymentUserGroupMap)</td>
</tr>
<tr class="odd">
...
Represents an object (<span
class="keyword">DeploymentUserGroupMap</span>) that holds mappings for
the users and deployment groups that are exported to the content
migration package.
...
The **UserGroupMap **element is the root
element of the DeploymentUserGroupMap <span
class="keyword">Schema</span> and therefore has no parent element.
