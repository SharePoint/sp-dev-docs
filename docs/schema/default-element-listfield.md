...
<tr class="even">
<td align="left"># Default Element (List - Field)</td>
</tr>
<tr class="odd">
...
The following example provides descriptive text and sets the default
value of the **FavoriteColor** field to black.
