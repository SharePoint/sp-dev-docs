...
<tr class="even">
<td align="left"># ByExtension Element (Document Icons)</td>
</tr>
<tr class="odd">
...
file to drive mapping between file extensions and their corresponding
document library icons.

If you want the document library feature to support a new file
...
Icons)](docicons-element-document-icons.htm)</span> for an example
