...
<tr class="even">
<td align="left"># Parameters Element in Method (BDCMetadataResource Schema)</td>
</tr>
<tr class="odd">
...
See <span sdata="link">[Parameters Element in Method (BDCMetadata
Schema)](parameters-element-in-method-bdcmetadata-schema.htm)</span> for more
details.
