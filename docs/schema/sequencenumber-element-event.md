...
<tr class="even">
<td align="left"># SequenceNumber Element (Event)</td>
</tr>
<tr class="odd">
...
Specifies the order to use for the event registration when more than one
handler is associated with the feature.
...
Handler](http://msdn.microsoft.com/library/c86de04e-6f5b-4082-9ed4-203b6303007b(Office.15).aspx)
