...
| **BaseType** | Required **Integer**. Specifies the base type, or default schema, for lists created from the definition.<ul><li>0 - GenericList</li><li>1 - DocumentLibrary</li><li>3 - DiscussionBoard</li><li>4 - Survey</li><li>5 - Issue |
...
| **Category** | Optional **Text**. Specifies the category with which to associate lists created through the list definition. Possible values include the following:<ul><li>`Libraries`</li><li>`Communications`</li><li>`Tracking`</li><li>`Custom Lists`</li></ul> |
