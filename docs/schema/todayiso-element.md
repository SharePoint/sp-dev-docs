...
<tr class="even">
<td align="left"># TodayISO Element</td>
</tr>
<tr class="odd">
...
Note that the date and time returned are relative to the server's local
time zone.


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

The following example evaluates the default value for a <span
class="keyword">DateTime</span> field type and inserts the current date
