...
<tr class="even">
<td align="left"># Groups Element (DeploymentUserGroupMap)</td>
</tr>
<tr class="odd">
...
Represents a collection of deployment group (<span
class="keyword">DeploymentGroup</span>) object instances.
