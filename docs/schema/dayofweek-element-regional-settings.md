...
<tr class="even">
<td align="left"># DayOfWeek Element (Regional Settings)</td>
</tr>
<tr class="odd">
...
Shared\\web server extensions\\15\\CONFIG) to contain an integer that
represents the day of the week on which standard time or daylight saving
time begins for a time zone.
