...
<tr class="even">
<td align="left"># Delegate Controls</td>
</tr>
<tr class="odd">
...
The following example specifies a control and tool tips to implement for
the input box of the search area in SharePoint pages.
...
<span sdata="cer"
target="T:Microsoft.SharePoint.WebControls.DelegateControl"><span
class="nolink">DelegateControl</span></span>

#### Other resources

[Delegate Control (Control
Templatization)](http://msdn.microsoft.com/library/e979328d-4985-4ed6-9085-7ff32a998dfc(Office.15).aspx)
