...
<tr class="even">
<td align="left"># Files Element (Upgrade)</td>
</tr>
<tr class="odd">
...
Contains descriptions of the relationships between existing provisioned
files and their equivalents for upgrading to Microsoft SharePoint
Foundation 2010.
