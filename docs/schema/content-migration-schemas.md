...
<ul>
<li><p>Contains the export settings specified by using the <"T:Microsoft.SharePoint.Deployment.SPExportSettings">SPExportSettings</span> class and other classes that are part of the content migration object model.</p></li>
