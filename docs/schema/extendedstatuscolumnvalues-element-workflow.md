...
<tr class="even">
<td align="left"># ExtendedStatusColumnValues Element (Workflow)</td>
</tr>
<tr class="odd">
...
<tbody>
<tr class="odd">
<td align="left"><p><span sdata="link"><a href="statuscolumnvalue-element-workflow.htm">StatusColumnValue Element (Workflow)</a></span></p></td>
</tr>
</tbody>
</table>
...
This element contains a collection of <span
class="keyword">StatusColumnValue</span> elements, each of which
represents a single custom status column value.
