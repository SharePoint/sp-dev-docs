...
<tr class="even">
<td align="left"># CompositeSteps element (WorkflowInfo element) (Action4)</td>
</tr>
<tr class="odd">
...
Container for the steps in a composite workflow activity, which are
represented by **CompositeStep** elements.
