...
<tr class="even">
<td align="left"># Case Element (View)</td>
</tr>
<tr class="odd">
...
<td align="left"><p>Optional **Text**. The value to check for in a comparison.</p></td>
</tr>
</tbody>
</table>
...
The following example checks the value of a <span
