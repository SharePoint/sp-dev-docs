...
<tr class="even">
<td align="left"># UrlBaseName Element (View)</td>
</tr>
<tr class="odd">
...
case-sensitive; note the lowercase "rl" in <span
class="keyword">UrlBaseName</span>.


------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

The following example uses the **UrlBaseName**
element to construct the absolute URL for a thumbnail image in a picture
library.
...
If the image file has a .jpg extension and is contained in a picture
library on a subsite, the example creates a URL in the following form:

<span
class="code">http://Server\_Name/Subsite\_Name/Library\_Name/\_t/File\_Base\_Name/\_jpg.jpg</span>
