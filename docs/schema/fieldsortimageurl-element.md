...
<tr class="even">
<td align="left"># FieldSortImageURL Element</td>
</tr>
<tr class="odd">
...
Returns the URL to the image file that is used to indicate how a column
is sorted. Rendering of this field is conditional, based on the current
sorting URL that is sent in the request to the server.
...
The following example creates an \<IMG\> tag for the icon that is used
to reflect the direction of a sort. The <span
