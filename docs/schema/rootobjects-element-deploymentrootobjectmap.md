...
<tr class="even">
<td align="left"># RootObjects Element (DeploymentRootObjectMap)</td>
</tr>
<tr class="odd">
...
Represents a collection of listed root object (<span
class="keyword">SPRootObject</span>) instances.
...
The **RootObjects** element is the root element
of the DeploymentRootObjectMap schema and therefore has no parent
element.
