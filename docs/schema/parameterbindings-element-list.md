...
<tr class="even">
<td align="left"># ParameterBindings Element (List)</td>
</tr>
<tr class="odd">
...
Contains a collection of stylesheet parameter bindings to make
information available to the XSL that renders the view.
...
For information about how to use this element, see [XSLT Parameter
