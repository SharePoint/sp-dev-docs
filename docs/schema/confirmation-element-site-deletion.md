...
<tr class="even">
<td align="left"># Confirmation Element (Site Deletion)</td>
</tr>
<tr class="odd">
...
body of the e-mail message sent to the creator of a site collection to
confirm whether the site collection is still in use.
