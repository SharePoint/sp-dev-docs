...
<tr class="even">
<td align="left"># ContextEventHandlers Element in DeclarativeContextDefinition (SolutionManifestDeclarativeExtensions Schema)</td>
</tr>
<tr class="odd">
...
The <span
class="keyword">DOCS-LESSTHANContextEventHandlersDOCS-GREATERTHAN</span>
element is used to specify the actions to be executed when a context
becomes active and the actions to be taken when a context is
deactivated.
