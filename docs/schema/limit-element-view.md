...
<td align="left"><p>Optional **Boolean</span>. **TRUE</span> to surround text with `<->` tags if the text appears like a hyperlink (for example, www.microsoft.com) but without HTML encoding.</p></td>
</tr>
<tr class="odd">
