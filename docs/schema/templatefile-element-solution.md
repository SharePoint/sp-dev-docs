...
<tr class="even">
<td align="left"># TemplateFile Element (Solution)</td>
</tr>
<tr class="odd">
...
<td align="left"><p>Required **Text**. Specifies a relative location within the solution that contains the template file.</p></td>
</tr>
</tbody>
</table>
