...
<tr class="even">
<td align="left"># Entities Element in ContextDefinition (SolutionManifestDefinitions Schema)</td>
</tr>
<tr class="odd">
...
Lists the external content type that is associated with this context
definition.
