...
<tr class="even">
<td align="left"># HTML Element (View)</td>
</tr>
<tr class="odd">
...
Escapes contained HTML tags so that the Collaborative Application Markup
Language (CAML) parser does not parse the tags.
