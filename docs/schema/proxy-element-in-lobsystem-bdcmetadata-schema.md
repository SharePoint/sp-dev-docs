...
<tr class="even">
<td align="left"># Proxy Element in LobSystem (BDCMetadata Schema)</td>
</tr>
<tr class="odd">
...
performance by removing the proxy generation overhead. To specify custom
