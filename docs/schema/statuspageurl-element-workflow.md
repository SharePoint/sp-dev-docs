...
<tr class="even">
<td align="left"># StatusPageUrl Element (Workflow)</td>
</tr>
<tr class="odd">
...
If you do not specify a custom status page, SharePoint Foundation uses
the default status page, located at <span
class="code">\_layouts/WrkStat.aspx</span>.
