...
|**RootWebOnly** <br/> |Optional **Boolean**. **TRUE** to specify that the site created from the configuration exists only as the root website in a site collection. This attribute is not enforced in [Web templates](https://msdn.microsoft.com/library/de422674-5cc4-4880-b08e-b1e955419d30%28Office.15%29.aspx), which are stored in Solution (`.wsp` files).  <br/> |
|**SubWebOnly** <br/> |Optional **Boolean**. **TRUE** to specify that the site created from the configuration exists only as a subsite within a site collection. This attribute is not enforced in [Web templates](https://msdn.microsoft.com/library/de422674-5cc4-4880-b08e-b1e955419d30%28Office.15%29.aspx), which are stored in Solution (`.wsp` files).  <br/> |
