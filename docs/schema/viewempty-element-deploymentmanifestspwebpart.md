...
<tr class="even">
<td align="left"># ViewEmpty Element (DeploymentManifest - SPWebPart)</td>
</tr>
<tr class="odd">
...
Represents a parameter that determines what is displayed in a Windows
SharePoint Services 3.0 Web Part when a query returns no list data for
the Web Part.
...
<span sdata="cer" target="P:Microsoft.SharePoint.SPView.ViewEmpty"><span
class="nolink">ViewEmpty</span></span>
