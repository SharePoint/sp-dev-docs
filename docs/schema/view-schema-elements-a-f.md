---
title: View schema elements A-F
manager: soliver
ms.date: 06/15/2022
description: Describes View schema elements A-F, which applies to SharePoint 2016, SharePoint Foundation 2013, SharePoint Online, SharePoint Server 2013.
