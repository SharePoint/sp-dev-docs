...
<tr class="even">
<td align="left"># ContextDeactivated Element in ContextEventHandlers (SolutionManifestDeclarativeExtensions Schema)</td>
</tr>
<tr class="odd">
...
Enables you to execute a specified action when a context is deactivated.
