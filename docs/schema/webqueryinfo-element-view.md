...
<tr class="even">
<td align="left"># WebQueryInfo Element (View)</td>
</tr>
<tr class="odd">
...
representation of the view. Consequently, agents that understand these
attributes can import a structured data view of lists rather than being
required to perform a "screenscrape" for the data.
