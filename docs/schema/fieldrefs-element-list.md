...
<tr class="even">
<td align="left"># FieldRefs Element (List)</td>
</tr>
<tr class="odd">
...
The following example creates a computed field called myField that
combines values of the Title and ID fields to form a hyperlink such as
<span class="code">\<a href="form.htm?ID="</span><span class="parameter"
sdata="paramReference">ID</span><span class="code">"\></span><span
