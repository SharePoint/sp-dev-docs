...
<tr class="even">
<td align="left"># ContentTypes Element (DeploymentManifest)</td>
</tr>
<tr class="odd">
...
Represents a container, or collection, of Windows SharePoint Services
3.0 content type specifications for list items.
...
<span sdata="cer"
target="T:Microsoft.SharePoint.SPContentTypeCollection"><span
class="nolink">SPContentTypeCollection</span></span>
