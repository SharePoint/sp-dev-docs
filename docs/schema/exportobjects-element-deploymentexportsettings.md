...
<tr class="even">
<td align="left"># ExportObjects Element (DeploymentExportSettings)</td>
</tr>
<tr class="odd">
...
Represents a collection of deployment export object instances for
inclusion in the content migration package.
...
class="nolink">SPExportObjectCollection</span></span> object.
