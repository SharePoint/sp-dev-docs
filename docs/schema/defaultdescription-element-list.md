...
<tr class="even">
<td align="left"># DefaultDescription Element (List)</td>
</tr>
<tr class="odd">
...
Sets the default description that appears in the title area of list
views and on the <span class="ui">Documents and Lists</span> page in
