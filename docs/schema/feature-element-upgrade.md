...
<tr class="even">
<td align="left"># Feature Element (Upgrade)</td>
</tr>
<tr class="odd">
...
Specifies a Feature to be marked as "provisioned" for Web sites or site
collections created in Microsoft SharePoint Foundation 2010.
...
<td align="left"><p>Required **GUID**. Specifies the identifier (ID) of the Feature.</p></td>
</tr>
</tbody>
</table>
