...
<tr class="even">
<td align="left"># Requirements Element (DeploymentRequirements)</td>
</tr>
<tr class="odd">
...
The **Requirements** element is the root
element in the DeploymentRequirements Schema, and therefore has no
parent element.
