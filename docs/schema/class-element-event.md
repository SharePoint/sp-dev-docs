...
<tr class="even">
<td align="left"># Class Element (Event)</td>
</tr>
<tr class="odd">
...
The **Class** element contains the fully
qualified name of the class in the following format:

<span class="code">MS.MyNameSpace.MyEventHandlerClass</span>
