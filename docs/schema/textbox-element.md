...
<td align="left"><p>Optional. Set to **TRUE</span> to set the Input Method Editor (IME) to the <span class="keyword">active</span> state. The default value is <span class="keyword">FALSE**.</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Optional. Set to **TRUE</span> to disable the text box so that it does not respond to user input and looks the same as a <a href="label-element.htm">Label</a> control. The default value is <span class="keyword">FALSE**.</p></td>
</tr>
<tr class="even">
