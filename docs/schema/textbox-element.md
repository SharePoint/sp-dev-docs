...
<td align="left"><p>Optional. Set to **TRUE</span> to disable the text box so that it does not respond to user input and looks the same as a <a href="label-element.md">Label</a> control. The default value is <span class="keyword">FALSE**.</p></td>
</tr>
<tr class="even">
