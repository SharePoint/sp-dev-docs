...
<tr class="even">
<td align="left"># Aggregations Element (List)</td>
</tr>
<tr class="odd">
...
Contains field references for totals columns or calculated columns — in
other words, for fields to which a function is applied.
...
The following example uses the **Aggregations**
element to contain references for a totals column and a calculated
column in a datasheet view. The first reference specifies that the Count
function is applied to the **Title** column;
