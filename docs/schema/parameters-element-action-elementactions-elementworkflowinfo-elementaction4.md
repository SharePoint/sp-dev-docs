...
Container for **Parameter** elements that includes descriptions of the parameters in **Action** method signatures. This element is of type [parametersType](parameterstype-complextype-action4.md).
