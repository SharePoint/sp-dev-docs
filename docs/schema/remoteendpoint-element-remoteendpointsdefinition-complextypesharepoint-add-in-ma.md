...
<tr class="even">
<td align="left"># RemoteEndpoint element (RemoteEndpointsDefinition complexType) (SharePoint Add-in Manifest)</td>
</tr>
<tr class="odd">
...
Declares an individual remote endpoint that the SharePoint Add-in may
access through the JSOM method SP.WebProxy.invoke().
...
<td align="left"><p>Only the authority part (scheme, host, and port) is significant, i.e. the path part is ignored.</p></td>
