...
description: Discusses the elements and attributes for the Action element (WorkflowActions) which is for the workflow engine to process a workflow activity.
manager: laurawi
ms.date: 3/9/2015
