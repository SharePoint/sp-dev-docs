...
> - SharePoint Online does not support these mobile object model APIs.
...
> [!WARNING]
> JSLink customization is deprecated and is not supported in modern SharePoint experiences. Use SharePoint Framework (SPFx) field customizers or column formatting instead.
>
