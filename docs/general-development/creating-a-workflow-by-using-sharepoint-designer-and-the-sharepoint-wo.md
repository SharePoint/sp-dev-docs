...
](/sharepoint/what-s-new/what-s-deprecated-or-removed-from-sharepoint-server-subscription-edition#sharepoint-designer-2013). For new workflows, we recommend using Visual Studio, see [Develop SharePoint workflows using Visual Studio](./develop-sharepoint-workflows-using-visual-studio).
