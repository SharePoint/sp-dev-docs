...
-  [Accessibility](http://msdn.microsoft.com/windows/bb735024.aspx)
    
  
-  [Design for Accessibility (Windows Store apps)](http://msdn.microsoft.com/library/windows/apps/hh700407.aspx)
    
  
-  [Meeting basic accessibility requirements (Windows Store apps using JavaScript and HTML)](http://msdn.microsoft.com/library/windows/apps/hh700338.aspx)
    
  
-  [Accessibility in Windows Store apps using JavaScript](http://msdn.microsoft.com/library/windows/apps/hh452702.aspx)
...
-  [Guidelines and checklist for accessibility](http://msdn.microsoft.com/library/windows/apps/hh700325.aspx)
...
-  [Accessibility for SharePoint](http://technet.microsoft.com/library/jj219681.aspx)
