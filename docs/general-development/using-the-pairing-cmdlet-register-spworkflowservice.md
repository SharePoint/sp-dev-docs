...
-  [Install and configure workflow for SharePoint](http://technet.microsoft.com/library/jj658588.aspx)
    
  
-  [Video series: Install and configure Workflow in SharePoint](http://technet.microsoft.com/library/dn201724.aspx)
    
  
-  [Workflow Manager 1.0](http://msdn.microsoft.com/library/jj193528%28Azure.10%29)
