...
The App.xaml file and its associated code-behind file, App.xaml.cs, are standard components of a managed Silverlight application. Applications that use the managed API for Silverlight must include a class derived from the Silverlight  [Application](http://msdn.microsoft.com/library/system.windows.application%28VS.95%29.aspx) class, in order to implement the Silverlight application model. The **Application** class supports application life-cycle events and facilities for managing resources like images, strings, and XAML templates.
...
-  [Using the Model-View-ViewModel Pattern](http://msdn.microsoft.com/library/hh821028.aspx)
    
  
-  [Pivot Control Architecture for Windows Phone](http://msdn.microsoft.com/library/ff941097%28VS.92%29.aspx)
    
  
-  [Silverlight Application Model](http://msdn.microsoft.com/library/cc872869%28VS.95%29.aspx)
    
  
-  [Developing a Windows Phone Application using the MVVM Pattern](http://msdn.microsoft.com/library/hh848247.aspx)
    
  
-  [WPF Apps With The Model-View-ViewModel Design Pattern](http://msdn.microsoft.com/magazine/dd419663.aspx)
