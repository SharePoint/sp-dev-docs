...
2. **Initialize the embedded workbook charts and the Bing Map**
    ...
    The next step is to initialize the Excel components and the Bing Map when the page loads. In order to access an embedded Excel workbook programmatically, you need to refer to it by a file token. See  [http://msdn.microsoft.com/library/hh315812.aspx](http://msdn.microsoft.com/library/hh315812.aspx) for information on how to get the appropriate file token for your workbook.
