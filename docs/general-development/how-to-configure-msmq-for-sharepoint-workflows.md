...
-  [About Message Queuing](http://msdn.microsoft.com/library/windows/desktop/ms706032%28v=vs.85%29.aspx)
    
  
-  [Message Queuing Reference](http://msdn.microsoft.com/library/windows/desktop/ms700112%28v=vs.85%29.aspx)
    
  
-  [Message Queuing Error and Information Codes](http://msdn.microsoft.com/library/windows/desktop/ms700106%28v=vs.85%29.aspx)
...
-  [Message Queuing (MSMQ)](http://msdn.microsoft.com/library/windows/desktop/ms711472%28v=vs.85%29.aspx)
