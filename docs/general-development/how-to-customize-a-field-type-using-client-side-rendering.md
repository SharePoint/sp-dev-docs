...
-  [How to: Create a Custom Field Type](http://msdn.microsoft.com/library/bb862248.aspx)
    
  
-  [Walkthrough: Creating a Custom Field Type](http://msdn.microsoft.com/library/bb861799.aspx)
