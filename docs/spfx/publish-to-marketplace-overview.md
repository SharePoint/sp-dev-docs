...
> [!IMPORTANT]
> You will need to use SharePoint Framework v1.11 or later for the solutions which are submitted to store. However, we recommend using the latest supported version of SPFx (v1.16 or later) for new solutions.
