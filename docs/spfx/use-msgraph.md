...
> [!NOTE]
> The single sign-on for the **MSGraphClient** is only available in SharePoint Online today. You can leverage the client for on premices developments but your users will be requested to sign in again within the webpart.
