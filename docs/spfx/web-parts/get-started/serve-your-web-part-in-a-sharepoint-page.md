...
1. In the console window, enter the following command to package your client-side solution that contains the web part:
    ...
    The command creates the package in the `sharepoint/solution` folder: **helloworld-webpart.sppkg**
...
1. In the **Search** box, enter **helloworld**, and select Enter to filter your apps.
