...
> [!NOTE]
> Using the AADHttpClient with SharePoint Framework directly using [Microsoft Authentication Library for JavaScript](https://learn.microsoft.com/en-us/javascript/api/overview/msal-overview) is not supported with SPFx version 1.4.1 and beyond. AADHttpClient is the recommended approach to authenticate for using Azure AD secured resources.
