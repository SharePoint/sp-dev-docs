---
title: SharePoint Framework v1.20.0 release notes
description: Release notes for the SharePoint Framework v1.20.0 release.
ms.date: 09/26/2024
ms.localizationpriority: high
---
# SharePoint Framework v1.20.0 release notes
...
## Upgrading projects from the SPFx v1.19 to v1.20.0 version
...
1. Install the new v1.20.0 package:
...
As part of the SPFx v1.19 release, we provided new line chart card layout option and with SPFx v1.20.0, we're introducing three new data visualization options: bar chart, pie chart and donut chart.

![Sample chart card layouts](../images/120-release-notes/chart-cards-options.png)

Related updated documentation for the SPFx v1.20.0 release:

- **[Create a Data Visualization Adaptive Card Extension](viva/get-started/build-data-visualization-adaptive-card-extension.md)** (tutorial): Step-by-step guide on creating Data Visualization Adaptive Card Extension - updated with the SPFx v1.20.0 release details
...
- **[Chart Card - Data Visualization Options](https://github.com/pnp/sp-dev-fx-aces/tree/main/samples/ChartCard-DataVisualizationOptions)**: Baseline example of the data visualization card rendering options, which was introduced as part of the SPFx v1.20.0 release.

### HTML Quick View support for Viva Connections cards

With the SPFx v1.20.0 version, we're introducing new option to use HTML to render the Viva Connection Adaptive Card Extension Quick Views. This enables more advanced user experiences. You can even use whatever suitable JavaScript web framework you prefer (that is: React etc.) in your Quick View experiences.
...
- **[Basic Card - HTML Quick View](https://github.com/pnp/sp-dev-fx-aces/tree/main/samples/BasicCard-HTML-QuickView)**: Baseline example of the data visualization card rendering options, which was introduced as part of the SPFx v1.20.0 release.
...
This issue has been fixed and is by default fixed for any new project created with the SPFx Yeoman generator 1.20.0. For the previously created project, you can fix this issue with following updates:
