...
- It runs in the context of the current user and connection in the browser. There are no `iframe`'s for the customization (JavaScript is embedded directly to the page).
