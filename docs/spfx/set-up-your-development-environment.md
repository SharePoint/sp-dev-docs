...
> [!IMPORTANT]
> The current supported LTS version of NodeJS for the SharePoint Framework is both **Node.js v8.x** and **Node.js v10.x** (recommended). Node.js v12.x is not currently supported. Notice that 9.x or 11.x versions are currently also not supported with SharePoint Framework development.
