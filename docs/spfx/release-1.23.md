...
For more information on the CLI, available templates, and all command options, see [SharePoint Framework CLI (spfx-cli)](./toolchain/spfx-cli.md). You can also review the [CLI README on GitHub](https://github.com/SharePoint/spfx/blob/main/apps/spfx-cli/README.md).
