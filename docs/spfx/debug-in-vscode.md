...
The easiest way to configure Visual Studio Code to debug SharePoint Framework solutions is by using the [Debugger for Edge](https://marketplace.visualstudio.com/items?itemName=msjsdiag.debugger-for-edge) or [Debugger for Chrome](https://marketplace.visualstudio.com/items?itemName=msjsdiag.debugger-for-chrome) Visual Studio Code extensions. 
...
In case you want to debug your projects in Microsoft Edge, you need to [install the Debugger for Edge extension for Visual Studio Code from the Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=msjsdiag.debugger-for-edge).
...
> [!NOTE] 
> In order for you to debug with Microsoft Edge, you will have to install the **Windows 10 April 2018 Update**. This update includes the **Microsoft Edge DevTools Protocol**.
