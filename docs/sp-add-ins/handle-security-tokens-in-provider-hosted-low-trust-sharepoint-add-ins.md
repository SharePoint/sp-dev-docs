...
|`nbf`||`1335822895`|
|`exp`||`1335866095`|
|`appctxsender`|Short for "application context sender". It represents the application that sent the context token to the SharePoint Add-in. It has the form `GUID of principal@SharePoint realm`, where _GUID of principal_ is the constant ID of the application principal; either SharePoint, Exchange 2013, Lync 2013, or Workflow.|`00000003-0000-0ff1-ce00-000000000000@040f2415-e6e3-4480-96ce-26ef73275f73`|
