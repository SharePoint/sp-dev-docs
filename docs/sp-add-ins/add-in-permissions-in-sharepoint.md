...
> [!NOTE]
> Site owners are not allowed to update add-in permissions in AppInv.aspx page by default. More information can be found [here](/powershell/module/sharepoint-online/set-spotenant#-SocialBarOnSitePagesDisabled).
