...
> [!NOTE]
> Site owners are not allowed to register ACS in AppRegNew.aspx by default. More information can be found [here](/powershell/module/sharepoint-online/set-spotenant#-socialbaronsitepagesdisabled).
