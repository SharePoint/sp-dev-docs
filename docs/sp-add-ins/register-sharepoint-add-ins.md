...
3. Select **Create** on the form. The page reloads and shows a confirmation of the values you entered. Make a record of these values in a form that is easy to copy and paste. You need to enter the values in web.config and AppManifest.xml files or in the Visual Studio Publish wizard.   
