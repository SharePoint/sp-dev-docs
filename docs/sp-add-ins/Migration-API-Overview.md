...
Package structure is based on a constrained version of the Content Deployment package schema. Documentation for the original full schema can be found at http://msdn.microsoft.com/en-us/library/bb249989(v=office.15).aspx. Until published on MSDN, the constrained structure can be found in this document in the appendix.
