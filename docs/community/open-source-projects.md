...
| [PnP modernization tooling and guidance](https://github.com/pnp/modernization) | Legacy SharePoint modernization tools and scripts. For new assessment work, see [Assess SharePoint modernization](../transform/assess-sharepoint-modernization.md). |
