...
To get started using PowerShell to manage SharePoint Embedded, you have to install the SharePoint Online Management Shell and connect to SharePoint Online. You need version [`16.0.24211.12000`](https://www.microsoft.com/download/details.aspx?id=35588) or higher to run the commands for SharePoint Embedded.
