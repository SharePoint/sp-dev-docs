...
> [!div class="nextstepaction"]
> [Add to Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=spe&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBtaWNyb3NvZnQvc3BlLW1jcCIsInN0YXJ0Il19)

> [!div class="nextstepaction"]
> [Add to LM Studio](lmstudio://add_mcp?name=spe&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBtaWNyb3NvZnQvc3BlLW1jcCIsInN0YXJ0Il19)
