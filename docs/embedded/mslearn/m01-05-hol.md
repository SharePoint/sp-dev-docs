---
title: Hands on Lab - Setup and Configure SharePoint repository services
description: This exercise guides you through creating a Microsoft Entra application, configuring SharePoint repository services on your SharePoint tenant, and generating your first Container Type and Container.
ms.date: 11/24/2023
ms.localizationpriority: high
---
# Hands on Lab - Setup and Configure SharePoint repository services

In this exercise, you’ll create an Microsoft Entra application, setup SharePoint repository services on your Microsoft 365 SharePoint tenant, and create your first Container Type and Container.
...
Custom SharePoint repository services applications use a custom Microsoft Entra application to authenticate and obtain the necessary permissions to call the Microsoft Graph and Microsoft SharePoint APIs.
...
- **Name**: SharePoint repository services app
...
After creating the SharePoint repository services **app,** Microsoft Entra displays the details of the new app. Create a text file to keep track of multiple values you’ll need later in this module.
...
Open a **Windows PowerShell**  prompt as an administrator and run the following PowerShell script. When prompted, enter the name for your certificate, such as SharePoint repository services:
...
## Create a new Container Type for your SharePoint repository services app
...
Name the environment SharePoint repository services.
...
Name the collection SharePoint repository services.
...
In Postman, select **Collections** from the left-hand navigation and expand the **SharePoint repository services > Application** node, select the **…** context menu on the **Containers** node, and select **Add request**.
...
In this exercise, you created an Microsoft Entra application, setup SharePoint repository services on your Microsoft 365 SharePoint tenant, and create your first Container Type using PowerShell, a new Postman collection and associated environment to submit requests to Microsoft Graph and SharePoint REST APIs.

## Next Steps

Let's get started and continue with the next topic in this tutorial, [Store and access files in SharePoint repository services with Microsoft Graph REST APIs](./m01-06-unit.md), where you'll learn how to use Microsoft Graph REST APIs to handle file storage and retrieval in SharePoint repository services.
