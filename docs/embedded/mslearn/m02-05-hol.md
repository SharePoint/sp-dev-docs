...
Now let’s create the an handler to get a list of the Containers using Microsoft Graph to be returned back to our React app. Create a new file **./server/listContainers.ts** and add the following imports to it:
