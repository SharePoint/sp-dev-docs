...
- **CLIENT_ENTRA_APP_CLIENT_ID**: This is the application (client) ID of the Microsoft Entra application you created previously.
    ...
    > [!NOTE]
    > In this module, this is the same value as the **API_ENTRA_APP_CLIENT_ID** as we’re using the same Microsoft Entra application for configuring the SharePoint Embedded app and the web application. In a production scenario, these can be two different Microsoft Entra applications.
