...
| Manage guest application permission | [Set-SPOApplicationPermission](/powershell/module/sharepoint-online/set-spoapplicationpermission) | `-OwningApplicationId`, `-ApplicationId`, `-PermissionAppOnly`, `-PermissionDelegated` | `Set-SPOApplicationPermission -OwningApplicationId <OwningApplicationId> -ApplicationId <ApplicationId> -PermissionAppOnly <AppOnlyPermission> -PermissionDelegated <DelegatedPermission>` |
