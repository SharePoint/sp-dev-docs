...
| Owning application | The Microsoft Entra ID application registration strongly coupled with a container type; each owning application owns exactly one container type. See [app architecture](../plan/app-tenant-architecture.md). |
