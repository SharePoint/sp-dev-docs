...
| Non-administrator | FileStorageContainer.Selected, FileStorageContainer.Manage.All | The application can access containers on behalf of a non-administrator user. Container instance-level [user permissions](#user-permissions) will apply. FileStorageContainer.Manage.All will be ignored.   |
