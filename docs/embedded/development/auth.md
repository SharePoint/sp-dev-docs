...
- Transitive membership. A user is a member of a [Microsoft 365 group](/microsoft-365/admin/create-groups/office-365-groups) that is itself a member of a container with specific permissions.
...
- [Operations that involve administrative actions on containers](#operations-that-involve-administrative-actions-on-containers)
