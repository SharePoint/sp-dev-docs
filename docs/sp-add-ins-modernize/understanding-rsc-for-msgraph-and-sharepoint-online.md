...
![The UI of Azure Active Directory when configuring the *Sites.Selected* application permission for an application via Microsoft Graph.](./assets/Understanding-RSC-for-MSGraph-and-SharePoint-Online/Understanding-RSC-for-MSGraph-and-SharePoint-Online-Sites.Selected-Graph.png)
...
> [!NOTE]
> In the samples folder associate with this article, you can find a [sample PowerShell script](../samples/Understanding-RSC-for-MSGraph-and-SharePoint-Online/SitesSelectedDemo/ManageSitesSelectedPermissions.ps1) that illustrates how to use the PnP PowerShell cmdlets for RSC. 
...
> [!NOTE]
> In the samples folder associate with this article, you can find a [sample .NET 6 console application](../samples/Understanding-RSC-for-MSGraph-and-SharePoint-Online/SitesSelectedDemo/SitesSelected.ConsumerApp/) that illustrates how to consume SharePoint Online sites leveraging the RSC model.
