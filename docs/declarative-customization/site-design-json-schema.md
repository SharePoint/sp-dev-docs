...
- **themeName** &ndash; The name of the theme to apply. Provide either this or themeJson.
- **themeJson** &ndash; An optional JSON object specifying the theme exactly. Provide either this or themeName. For more details on this check out https://aka.ms/spsitetheming. See https://aka.ms/spthemebuilder if you need help generating a custom theme.
