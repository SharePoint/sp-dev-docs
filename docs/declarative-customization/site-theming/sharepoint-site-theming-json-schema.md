...
* __name__ &mdash; The name of the theme, which appears in the theme picker user interface and is also used by administrators and developers to refer to the theme in PowerShell commands or calls to the SharePoint REST API.
...
* __backgroundImageUril__ &mdash; The URI of an optional background image for the theme (value may be blank if no background image).
...
The following code demonstrates how to define a dictionary in PowerShell for the Red theme's color palette.
```powershell
{ 
    themeDarker: '#751b1e', 
    themeDark: '#952226', 
...
The following code demonstrates how to define a dictionary in PowerShell for the Orange theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Green theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Blue theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Purple theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Gray theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Dark Yellow theme's color palette.
...
The following code demonstrates how to define a dictionary in PowerShell for the Dark Blue theme's color palette.
