---
title: Common CSV reference for a classic pages assessment
description: Reference the common scan, property, history, site collection, and web files generated by a Classic Pages assessment.
ms.date: 07/27/2026
ms.localizationpriority: high
ms.service: sharepoint
---

# Common CSV reference for a classic pages assessment
