---
title: Create SharePoint hub sites using Office 365 CLI
description: Example code for creating a SharePoint hub site by using Office 365 CLI.
ms.date: 6/20/2019
localization_priority: Priority
---

# Create SharePoint hub sites by using Office 365 CLI

If you're a global or SharePoint admin in Office 365, you can convert any existing site to a hub site by using Office 365 CLI. In this example, you'll learn how to create a SharePoint hub site and to associate another site with it. In this scenario, you are setting up sites for the Contoso marketing department:
