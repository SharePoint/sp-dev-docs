...
- Receive notifications of changes occurring in SharePoint. For example, when a new item is added to a list, you want to perform a task.
...
3. To run this code sample, you need an Azure subscription. To sign up for a trial, see [Free one-month trial](https://azure.microsoft.com/pricing/free-trial/).
